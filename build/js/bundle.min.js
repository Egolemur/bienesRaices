function darkmode(){const e=window.matchMedia("(prefers-color-scheme: dark");e.matches?document.body.classList.add("activado"):document.body.classList.remove("activado"),e.addEventListener("change",(function(){document.body.classList.toggle("activado")}));document.querySelector(".darkmode").addEventListener("click",(function(){document.body.classList.toggle("activado")}))}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
